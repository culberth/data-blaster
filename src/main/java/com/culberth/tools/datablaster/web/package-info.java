 ...
 * {@link com.culberth.tools.datablaster.model.AppState#snapshot() AppState.snapshot()}, which returns an
 * immutable copy safe to read from any thread. To change it, hand the mutation to
 * {@link com.culberth.tools.datablaster.model.AppState#onFxThread(Runnable) AppState.onFxThread(Runnable)}.
 *
